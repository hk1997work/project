...
const projRoles = ["Principal Investigator", "Researcher", "Field Technician", "Data Analyst", "Project Manager", "Ecologist"];
...
const dbSchema = {
    ...
    project_contributor: {
        label: "Proj. Contributors", itemLabel: "Contributor", icon: "user-cog", pk: "composite_id",
        columns: [
            {key: "composite_id", label: "ID", type: "text", readonly: true, hiddenInTable: true},
            {key: "project_id", label: "Project", type: "select", options: []},
            {key: "user_id", label: "User", type: "select", options: mockNames},
            {key: "contribution_role", label: "Role", type: "select", options: projRoles},
            {key: "added_date", label: "Date Added", type: "text", readonly: true}
        ]
    },
    collection_contributor: {
        label: "Coll. Contributors", itemLabel: "Contributor", icon: "users-2", pk: "composite_id",
        columns: [
            {key: "composite_id", label: "ID", type: "text", readonly: true, hiddenInTable: true},
            {key: "collection_id", label: "Collection", type: "select", options: []},
            {key: "user_id", label: "User", type: "select", options: mockNames},
            {key: "contribution_role", label: "Role", type: "select", options: colRoles},
            {key: "added_date", label: "Date Added", type: "text", readonly: true}
        ]
    },
    media: {
